...
namespace TapEmpire.Services.Notifications
{
    ...
    /// </summary>
    public class PendingNotificationSerializer : IPendingNotificationsSerializer
    {
        ...
        /// <summary>
        /// Instantiate a new instance of <see cref="PendingNotificationSerializer"/>.
        /// </summary>
        /// <param name="filename">The filename to save to. This should be an absolute path.</param>
        public PendingNotificationSerializer(string filename)
        {
