...
namespace Prime31.Editor
{
    ...
    {
        private const string FOLDER_LOCATION = "_AutoGenerated/Constants/";
        ...
        [MenuItem("TapEmpire/Helpers/Generate Constants Classes...")]
        ...
        {
            var folderPath = $"{Application.dataPath}/{ProjectPathSettings.Instance.DefaultGameFolder}/{FOLDER_LOCATION}";
        ...
        private static string getClassContent(string className, string[] labelsArray)
        {
            ...
            if (className == SCENES_FILE_NAME.Replace(".cs", string.Empty))
            {
				...
				output += "\t\t\tvar scene = SceneManager.GetActiveScene();\n";
				output += "\t\t\tvar sceneIndex = scene.buildIndex;\n";
				output += "\t\t\treturn (sceneIndex + 1 == TOTAL_SCENES) ? 0 : sceneIndex + 1;\n";
                output += "\t\t}\n";
            }
